...
namespace GoogleARCore.Examples.ObjectManipulation
{
    ...
    public abstract class Manipulator : MonoBehaviour
    {
        ...
        public void Select()
        {
            ArCoreManipulationSystem.Instance.Select(gameObject);
        }
        ...
        protected virtual void Update()
        {
            if (m_SelectedObject == gameObject &&
                ArCoreManipulationSystem.Instance.SelectedObject != gameObject)
            {
                m_SelectedObject = ArCoreManipulationSystem.Instance.SelectedObject;
                OnDeselected();
            }
        ...
        private void ConnectToRecognizers()
        {
            ...
            DragGestureRecognizer dragGestureRecognizer =
                ArCoreManipulationSystem.Instance.DragGestureRecognizer;
            ...
            PinchGestureRecognizer pinchGestureRecognizer =
                ArCoreManipulationSystem.Instance.PinchGestureRecognizer;
            ...
            TapGestureRecognizer tapGestureRecognizer =
                ArCoreManipulationSystem.Instance.TapGestureRecognizer;
            ...
            TwistGestureRecognizer twistGestureRecognizer =
                ArCoreManipulationSystem.Instance.TwistGestureRecognizer;
            ...
            TwoFingerDragGestureRecognizer twoFingerDragGestureRecognizer =
                ArCoreManipulationSystem.Instance.TwoFingerDragGestureRecognizer;
        ...
        private void OnUpdated(DragGesture gesture)
        {
            ...
            if (ArCoreManipulationSystem.Instance.SelectedObject != gameObject)
            {
